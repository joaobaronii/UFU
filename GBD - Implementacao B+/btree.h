...
private:
     ...
     */
    int insereRecursivo(int chave, int valor, int numPagina, int nivel, int *chavePromovida, int *paginaPromovida);

    void insereNaPagina(pagina *pg, int chave, int valor, int paginaDireita);

    void dividirNo(pagina *pg, int chave, int valor, int paginaDireita, int *chavePromovida, int *paginaPromovida); 
};
